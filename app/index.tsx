...
export default function Index() {
  ...
  const { contentUnlocked, updateGameState, isReady } = useGame();
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={[styles.subheader, styles.text]}>
        A solo game of dishonesty by Michelle Kelly
      </Text>

      <Pressable onPress={restartAndReroute} style={styles.button}>
        <Text style={[styles.button, styles.text]}>New Game</Text>
      </Pressable>
      <Pressable onPress={() => router.push("/game")} style={styles.button}>
        <Text style={[styles.button, styles.text]}>Continue Game</Text>
      </Pressable>
      <Pressable onPress={() => router.push("/about")} style={styles.button}>
        <Text style={[styles.button, styles.text]}>About</Text>
      </Pressable>
      {!contentUnlocked && (
        <Pressable onPress={() => router.push("/unlock")} style={styles.button}>
          <Text style={[styles.button, styles.text]}>Unlock Content</Text>
        </Pressable>
      )}
    </View>
  );
